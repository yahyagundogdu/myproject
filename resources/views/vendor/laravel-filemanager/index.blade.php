...
<body>
  ...
  <nav class="bg-light fixed-bottom border-top d-none" id="actions">
    ...
    <a data-action="use" data-multiple="true"><i class="fas fa-check"></i>{{ trans('Tamam') }}</a>
  </nav>
  ...
  <div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('laravel-filemanager::lfm.btn-close') }}</button>
          <button type="button" class="btn btn-primary w-100" data-dismiss="modal">{{ trans('Tamam') }}</button>
        </div>
      </div>
    </div>
  </div>
