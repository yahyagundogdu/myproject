    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Galeri Kategorileri</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Ana Sayfa</a></li>
                            <li class="breadcrumb-item active">Galeri Kategorileri</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-12">
                        <a href="{{ route('galeri-kategori.create') }}" class="btn btn-success mb-2">Yeni Galeri Kategorisi Ekle</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($category as $data)
                                    <tr id='remove_{{$data->id}}'>
                                        ...
                                        <td>{{ $data->slug }}</td>
                                        <td>
                                            <a href="galeri-kategori/{{$data->id}}/edit" class="btn btn-sm btn-primary"><i class="far fa-edit"></i></a>
            ...
            $('.removerole').click(function() {
                ...
                if (confirm(confirmText)) {
                    $.ajax({
                        ...
                        url:"galeri-kategori/"+dataiddelete,
