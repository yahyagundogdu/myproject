...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('urunler.create')}}" class="btn btn-success btn-sm"><i class="fas fa-plus-square mx-1"></i> Yeni Ürün Ekle</a>
                    <a href="" class="btn btn-info btn-sm"><i class="fas fa-tags mx-1"></i> Kategoriler</a>
                    <a href="" class="btn btn-warning btn-sm"><i class="fas fa-project-diagram mx-1"></i> Varyasyon Grupları</a>
                </div>
            </div>
            <div class="card">
