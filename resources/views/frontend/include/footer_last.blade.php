<footer class="footer">
    ...
    <div class="footer__top">
        <div class="footer__logo">
            <img src="{{ Storage::url(Helpers::setting('site.logo')) }}" alt="footer-logo" width="300" height="85">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="footer__top-blocks">
                        ...
                        <div class="content">
                            <div class="content-item">
                                ...
                                <div class="text">
                                    <a
                                        href="tel:{{ Helpers::setting('site.phone_gsm') }}">{{ Helpers::setting('site.phone_gsm') }}</a>
                                </div>
                            </div>
                            <div class="content-item">
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p>{{ Helpers::setting('site.adres') }}</p>
                                </div>
                            </div>
                            <div class="content-item">
                                <div class="icon">
                                ...
                                <div class="text">
                                    <a
                                        href="mailto:{{ Helpers::setting('site.mail') }}">{{ Helpers::setting('site.mail') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="footer__top-blocks">
                        <h1 class="title">ÇALIŞMA SAATLERİ</h1>
                        <div class="content">
                            <ul class="work-date">
                                <li><span>Pzt - Cumt:</span><b> 09:00 - 18:00</b></li>
                            </ul>
                        </div>
                        <div class="socials">
                            <a target="_blank" href="{{Helpers::setting( 'Facebook' )}}" title="facebook" class="mr-1"><i class="fa fa-facebook"></i></a>
                            <a target="_blank" href="{{Helpers::setting( 'instagram' )}}" title="instagram" class="mr-1"><i class="fa fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="footer__top-blocks">
                        <h1 class="title">{{ Helpers::setting('site.title') }}</h1>
                        <div class="content">
                            <ul class="menu">
                                <li>
                                    <a href="{{ route('hakkimizda') }}"><i
                                            class="fa fa-angle-right mr-1"></i>Hakkımızda</a>
                                </li>
                                <li>
                                    <a href="{{ route('ekibimiz') }}"><i class="fa fa-angle-right mr-1"></i>Ekibimiz</a>
                                </li>
                                <li>
                                    <a href="{{ route('tedaviler') }}"><i class="fa fa-angle-right mr-1"></i>Tedaviler</a>
                                </li>
                                <li>
                                    <a href="{{ route('sss') }}"><i class="fa fa-angle-right mr-1"></i>SSS</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="footer__bottom">
        <p style="text-white">Tüm Hakları Saklıdır © {{ date('Y') }} <a class="text-white"
                href="{{ Helpers::setting('site.tasarimci') }}" target="_blank">Assa Pars</a> </p>
    </div>
