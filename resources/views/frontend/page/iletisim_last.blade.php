...
@section('content')
    ...
    <header class="header-bottom-4">
        ...
        <div class="container">
            <h1 class="section-title">İLETİŞİM</span></h1>
            <ol class="breadcrumb">
    ...
    <section class="contact main-blog">
        ...
        <div class="contact-map-2">
            {!! Helpers::setting('harita_adresi') !!}
            <div class="container">
                <div class="contact-map__card-2">
                    <img src="/frontend/images/jpg/contact2.jpg">
                    <div class="blue"></div>
                    <div class="content">
                        <div class="locations">
                            <div class="item">
                                ...
                                <a href="tel:{{ Helpers::setting('site.phone_gsm') }}"
                                    class="tel">{{ Helpers::setting('site.phone_gsm') }}</a>
                            </div>
                            <div class="item">
                                <div class="icon">
                                ...
                                <p class="adress">{{ Helpers::setting('site.adres') }}</p>
                            </div>
                            <div class="item">
                                <div class="icon">
                                ...
                                <a href="mailto:{{ Helpers::setting('site.mail') }}"
                                    class="email">{{ Helpers::setting('site.mail') }}</a>
                            </div>
                        ...
                        <form action="{{ route('randevuolustur') }}" method="POST">
                            @csrf
                            @method('post')
                            <input type="hidden" name="formPath" value="İletişim">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <textarea name="data[][Mesaj]" class="form-control"
                                        placeholder="Mesajınız"></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <input name="data[][Adı]" type="text" class="form-control" placeholder="Adınız">
                                </div>
                                <div class="form-group col-md-6">
                                    <input name="data[][Soyadı]" type="text" class="form-control"
                            ...
                            <button type="submit" class="btn btn-2_pink" style="background-color: #F5C6A5">Gönder</button>
                        </form>
                    </div>
                </div>
            </div>
